...
{{--                                                    <x-fields.media-upload :title="__('Campaign Image')" :name="'image'" :dimentions="'1920x1080'"/>--}}
                                                    ...
                                                    @if(!empty(get_static_option('tenant_admin_dashboard_theme') ) && get_static_option('tenant_admin_dashboard_theme') == 'metronic')
                                                        <x-fields.media-upload-for-metronic :title="__('Campaign Image')" :name="'image'" :dimentions="'1920x1920'"/>
                                                    @else
                                                        <x-fields.media-upload :title="__('Campaign Image')" :name="'image'" :dimentions="'1920x1080'"/>
                                                    @endif
