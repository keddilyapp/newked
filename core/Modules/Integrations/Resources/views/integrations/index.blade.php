...
@section('style')
    <style>
        ...
        .card-focus {
            animation: card-focus-animation 1.5s linear infinite;
        }
            ...
            <div class="col-md-12">
                <div class="recent-order-wrapper dashboard-table bg-white padding-30">
                    ...
                    <div class="plugin-grid">
                        ...
                        <div class="plugin-card">
                            <div class="thumb-bg-color instagram" id="instagram">
...
@section('scripts')
    <script>
        (function ($) {
            ...
            let hashText = currentURL.split('#')[1];

            let integrationCard;
            if (hashText !== undefined) {
                integrationCard = $(`#${hashText}`).closest('.plugin-card');
                integrationCard.addClass('card-focus');
            }

            if (integrationCard !== undefined) {
                $(document).on('mouseover', '.plugin-card', function () {
                    let el = $(this);

                    if (el.hasClass('card-focus')) {
                        el.removeClass('card-focus')
                    }
                })
            }
        })(jQuery);
