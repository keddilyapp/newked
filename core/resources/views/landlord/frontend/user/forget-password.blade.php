...
@section('content')
    <section class="login-page-wrapper  bg-black" data-padding-top="100" data-padding-bottom="100">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="login-form-wrapper custom--form signIn-signUp-wrapper  bg-black">
