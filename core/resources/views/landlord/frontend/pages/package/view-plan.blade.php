...
@section('content')
    ...
    <div class="loader loader_page_single">
        <div class="loader_wrapper bg-black">
            <div class="loader-01">
    ...
    <section class="order-service-page-content-area padding-100 bg-black">
        <div class="container">
            ...
            <div class="row justify-content-center bg-black">
                <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                    <div class="price-plan-left-wrap  bg-black">
                    ...
                    <div class="price-plan-left-wrap mt-4 bg-black">
                ...
                <div class="col-xl-9 col-lg-8 col-md-7 col-sm-8">
                    <div class="single-price-plan-item price-plan-two  bg-black">
                                ...
                                @foreach($faq_items['title'] as $faq)
                                    ...
                                    <div class="card my-2" itemscope itemprop="mainEntity"
                                        ...
                                        <div id="collapseOne_{{$loop->index}}"
                                            ...
                                            <div class="card-body  bg-black" itemprop="text">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <form action="" class="mt-5" method="POST">
                                ...
                                <input type="hidden" name="theme_slug" id="theme-slug" value="{{$default_selected_theme ?? get_static_option('default_theme')}}">
