    ...
    <div class="name_badge d-flex">
        <h2 class="details-title"> {!! $product->name !!}
            @if(!empty($product->badge))
                <span
                    class="global-card-thumb-badge-box global-card-thumb-badge-box-product-details  bg-color-new "> {{$product?->badge?->name}} </span>
            @endif
        </h2>
    ...
    <div class="shop-details-stock shop-border-top pt-4 mt-4">
        <ul class="stock-category">
            <li class="category-list">
                ...
                {{--                    <a href="{{route('tenant.shop.category.products', [$product?->category?->slug])}}">{{$product?->category?->name}}</a>--}}

                {{--                    @if($product?->subCategory?->slug)--}}
                {{--                        |--}}
                {{--                        <a href="{{route('tenant.shop.category.products', [$product?->subCategory?->slug])}}">{{$product?->subCategory?->name}}</a>--}}
                {{--                    @endif--}}
                ...
                {{--                            |--}}
                {{--                        @endif--}}
                {{--                        <a href="{{route('tenant.shop.category.products', [$child_category?->slug])}}"> {{$child_category->name}} </a>--}}
