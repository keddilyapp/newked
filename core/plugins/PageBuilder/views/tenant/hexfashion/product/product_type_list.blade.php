                ...
                <div class="tab-content-item active" id="all">
                    <div class="row">
                        @foreach($data['products'] as $product)
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-6 col-{{productCards()}} mt-4">
                                <div class="global-card no-shadow radius-0 pb-0">
                                    ...
                                    <div class="global-card-contents">
                                        <div class="global-card-contents-flex">
                                            <h5 class="global-card-contents-title"> <a href="{{dynamicRoute($product->slug)}}"> {!! product_limited_text($product->name) !!} </a> </h5>
