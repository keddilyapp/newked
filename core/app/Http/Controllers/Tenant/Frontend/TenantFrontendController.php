   ...
   -------------------------- */
    ...
    public function product_by_category_ajax_one(Request $request)
    {
        ...
        foreach ($products as $product) {
            ...
            $route = dynamicRoute($product->slug);
    ...
    public function topbar_search(Request $request)
    {
        ...
        foreach ($product_object as $item) {
            ...
            $markup .= '<li class="product-suggestion-list-item">
                           <a href="' . dynamicRoute($item->slug) . '" class="product-suggestion-list-link">
...
//    }
    ...
    public function category_products($slug)
    {
        ...
        return themeView('shop.single_pages.category', ['category' => $queryResult, 'products' => $products]);
    }
