...
use App\Http\Controllers\Tenant\Admin\TenantDashboardThemeManageController;
...
Route::middleware([
    ...
    Route::prefix('s')->as('tenant.')->group(function (){
...
//        Route::get('c/{category_slug}', [TenantFrontendController::class, 'category_products'])->name('shop.category.products'); // Product Category / Subcategory / ChildCategory
        ...
        //tenant theme manage
        Route::get('dashboard-themes/', [TenantDashboardThemeManageController::class,'index'])->name('admin.dashboard.theme.all')->middleware('adminglobalVariable');
        Route::post('dashboard-themes/update/{slug}', [TenantDashboardThemeManageController::class,'update'])->name('admin.dashboard.theme.update')->middleware('adminglobalVariable');
        ...
        Route::prefix("/")->as("user.frontend.")->group(function (){
            Route::controller(CheckoutPaymentController::class)->group(function (){
                ...
                Route::post('/awdpay-ipn', 'awdpay_ipn')->name('awdpay.ipn');
